                    ...
                    <div className="container--1428 header__inner">
                        ...
                        <div className="header__support">
                            <div className="header__search">
                                ...
                                <div
                                    className="search--sp js-search-sp"
                                    onClick={handleSearchClick}
                                >
                            ...
                            {!auth ? (
                                <>
                                    ...
                                    <ul className="login__nav pc-only">
                                        ...
                                        <li>
                                            <button onClick={handleSignInToggle}>Đăng ký</button>
                                        </li>
                                    </ul>
                                    ...
                                    <div className="header__account">
                                        <Link to="/tai-khoan" className="header__account-link">
                                            <img
                                                ...
                                                src={localStorage.getItem("customerAvatar") || noAvatar}
                                                loading="lazy"
                                                alt="avatar"
                                            />
                                            <span id="account-email">{localStorage.getItem("customerEmail") || "No Info"}</span>
                                        </Link>
                                    </div>
                                </>
                            )}
                            ...
                            <div className="lang">
                                <div className="lang__active">
                                    <img
                                        className="lang__flag js-lang-flag"
                                        src={iconFlagVi}
                                        alt="VN"
                                    />
                                    <img
                            ...
                            <div
                                className={`hamburger ${navigationOpen ? "is-active" : ""}`}
                                onClick={() => {
                    ...
                    <div className="container">
                        <nav className="nav">
                            ...
                            <ul className="nav__list">
                                ...
                                <li>
                                    <Link to="/loai-su-kien/san-khau-nghe-thuat/">
                                        Sân khấu & Nghệ thuật
                                    </Link>
                                </li>
                                <li>
